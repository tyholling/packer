source "qemu" "debian" {
  ...
  iso_target_path  = "debian-12.10.0-arm64-DVD-1.iso"
  iso_url          = "https://cdimage.debian.org/debian-cd/current/arm64/iso-dvd/debian-12.10.0-arm64-DVD-1.iso"
  memory           = "8192"
  output_directory = "."
  ...
  qemuargs = [
    ...
    ["-drive", "file=debian-12.10.0-arm64-DVD-1.iso,if=none,format=raw,id=cdrom"],
