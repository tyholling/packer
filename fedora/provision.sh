...
ansible fedora -i .inventory -u root -m wait_for_connection --ssh-common-args='-o StrictHostKeyChecking=no'
ansible fedora -i .inventory -u root -m hostname -a name=$hostname
ansible-playbook -l fedora -i .inventory -u root ../ansible/script.yaml
